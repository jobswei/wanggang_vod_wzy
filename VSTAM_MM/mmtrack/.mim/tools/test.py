...
def main():
    ...
    # if "vstam" in args.config:
    #     from mmtrack.vstam import vstam
    #     vstam.test(args.config,args.out)
    #     return 
    ...
    if "vstam" in args.config:
        ...
        vstamcfg.merge_from_file(dir_name+"/vstam_model_config.yaml")
        model = build_model(vstamcfg)
    else:
