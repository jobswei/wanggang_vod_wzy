...
from mmtrack.datasets.vid_mega import build_mega_dataloader
from mmtrack.utils import build_ddp, build_dp, get_root_logger
from mmdet.apis import train, test
...
def train_model(model,
    ...
    if model.__class__.__name__ == 'GeneralizedRCNNMEGA':
        data_loaders = [
            build_mega_dataloader(
                ds,
                1,
    ...
    if validate:
        ...
        if model.module.__class__.__name__ == 'GeneralizedRCNNMEGA':
            val_dataloader = build_mega_dataloader(
                val_dataset,
                1,
                cfg.data.workers_per_gpu,
                shuffle=False,
